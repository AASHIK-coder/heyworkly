            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-100 to-slate-200/80 dark:from-slate-700 dark:to-slate-800/80 flex items-center justify-center shadow-sm ring-1 ring-slate-200/50 dark:ring-slate-600/30">
                  <MousePointerClick className="text-slate-600 dark:text-slate-300" size={14} />
                </div>
                {status && (
                  <div
                    className={`absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full flex items-center justify-center shadow-sm ${
                      status === 'success'
                  ...
                  >
                    {status === 'success' ? (
                      <CheckCircle className="text-white" size={9} />
                    ) : (
                      <XCircle className="text-white" size={9} />
                    )}
                  </div>
                )}
              </div>
            ...
            <div className="group">
              <div className="flex items-center mb-2">
                <div className="w-5 h-5 rounded-md bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center mr-2.5 ring-1 ring-blue-200/50 dark:ring-blue-800/50">
                  <Eye className="text-blue-600 dark:text-blue-400" size={11} />
                </div>
                <h4 className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                  Thought
                </h4>
              </div>
              <div className="ml-[30px] p-3 bg-blue-50/30 dark:bg-blue-900/10 rounded-lg border border-blue-100/50 dark:border-blue-800/30 transition-colors group-hover:bg-blue-50/50 dark:group-hover:bg-blue-900/20">
            ...
            <div className="group">
              <div className="flex items-center mb-2">
                <div className="w-5 h-5 rounded-md bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center mr-2.5 ring-1 ring-indigo-200/50 dark:ring-indigo-800/50">
                  <ChevronsRight className="text-indigo-600 dark:text-indigo-400" size={11} />
                </div>
                <h4 className="text-xs font-semibold text-slate-700 dark:text-slate-300">Step</h4>
              </div>
              <div className="ml-[30px] p-3 bg-indigo-50/30 dark:bg-indigo-900/10 rounded-lg border border-indigo-100/50 dark:border-indigo-800/30 transition-colors group-hover:bg-indigo-50/50 dark:group-hover:bg-indigo-900/20">
            ...
            <div className="group">
              <div className="flex items-center mb-2">
                <div className="w-5 h-5 rounded-md bg-slate-50 dark:bg-slate-800 flex items-center justify-center mr-2.5 ring-1 ring-slate-200/50 dark:ring-slate-600/50">
                  <Type className="text-slate-600 dark:text-slate-400" size={11} />
                </div>
